...
import { faUser, faEnvelope, faLock, faUserPlus, faInfoCircle } from "@fortawesome/free-solid-svg-icons";
...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("Signing up with:", { name, email, password, about });
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            ...
            <Link href="/pages/Login" className="font-medium text-blue-600 hover:text-blue-500">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <div className="mt-8 bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FontAwesomeIcon icon={faInfoCircle} className="h-5 w-5 text-gray-400" />
                </div>
                <textarea
                  id="about"
                  name="about"
